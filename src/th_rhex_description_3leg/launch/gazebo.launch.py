...
def generate_launch_description():
    ...
    urdf_path = os.path.join(pkg_share, "urdf", "3leg_Th_Rhex_v2.urdf")
    ...
    return LaunchDescription(
        [
            ...
            # 6. Spawn joint_state_broadcaster after short delay
            TimerAction(
                period=3.0,
                actions=[
                    Node(
            ...
            # 7. Spawn leg velocity controller after joint_state_broadcaster
            TimerAction(
                period=4.0,
                actions=[
                    Node(
